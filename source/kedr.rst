...
1. Нажать правой клавишей мыши на кнопку |image32|, которая расположена слева от требуемой координаты. Например, если новую точку следует добавить между первой и второй координатой, слдеует нажать на кнопку |image32|, расположенную слева от первой координаты (рис. 48). Затем требуется выполнить одну из следующих команд контекстного меню:
...
2. Нажмать левой клавишей мыши на кнопку |image32|, которая расположена слева от требуемой координаты. Ниже добавится новая координата, в полях **Широта** и **Долгота** которой будут указаны градусы (целые числа до запятой) из выбранной координаты (рис. 49).<br><br>
