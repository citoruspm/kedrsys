...
В блоке **Геопривязка** (рис. 45) отображается точка инцидента, установленная диспетчером на карте, и геокоординаты данной точки. Геокоординаты отображаются в следующих форматах:
...
- Во вкладке **Поворотные углы** – в виде десятичной дроби, аналогично вкладке **ГГ.ГГГГГГ**.

При необходимости диспетчер может редактировать положение точки или преобразовать ее в линию или полигон.

Редактирование фигуры объекта можно выполнять:

-   На карте, с помощью инструментов визуального редактора (рис. 45, цифра 1). При этом в области координат (рис. 45, цифра 2), во вкладках **ГГ.ГГГГГГ** и **ГГºММ’СС.с** будут соответствующим образом меняться координаты точек фигуры, а во вкладке **Поворотные углы** будут соответствующим образом меняться линии и азимуты.
-   В области координат (рис. 45, цифра 2), вручную добавляя и редактируя координаты точек/линии и азимуты фигуры. При этом на карте в реальном режиме времени фигура будет перемещаться и видоизменяться в соответствии с указанными данными.
...
Если из точки требуется сделать линию, следует добавить на карту новую точку. Для этого необходимо нажать на кнопку |image31|. Указатель мыши преобразится в маркер (рис. 46). Данный маркер щелчком мыши следует установить на требуемом месте карты. От первого маркера до второго будет прорисована линия.
...
Чтобы отрисовать фигуру путем указания координат ее крайних точек, в области координат следует выбрать вкладку **ГГ.ГГГГГГ** или **ГГºММ’СС.с** и добавить точки фигуры одним из следующих способов:
...
Если какую-либо из точек фигуры требуется выделить на карте, следует нажать на кнопку, на которой обозначен порядковый номер данной точки (рис. 50).

Если какие-либо координаты точки требуется поменять местами, следует использовать команды контекстного меню **Поднять наверх** и **Опустить вниз** (рис. 48).
...
Если требуется удалить какую-либо координату фигуры, следует выполнить для этой координаты команду контекстного меню **Удалить**.
 ...
 .. figure:: _static/scenarii_35_1.png
           :scale: 100 %
           :align: center        
           
           Рисунок 50 – Просмотр точки на карте
	   
Чтобы отрисовать фигуру путем создания поворотных углов, из точки, первоначально установленной на карте, требуется создать линию одним из способов, описанных выше. После этого в области координат следует выбрать вкладку **Поворотные углы** (рис. 51) и создать новую линию фигуры одним из следующих способов:

- Нажать правой клавишей мыши на кнопку |image32|, которая расположена слева от первой линии и выполнить команду контекстного меню **Создать новый** или **Клонировать**.
- Нажать левой клавишей мыши на кнопку |image32|, которая расположена слева от первой линии.
	   
 .. figure:: _static/scenarii_35_2.png
           :scale: 100 %
           :align: center        
           
           Рисунок 51 – Контекстное меню   

Ниже добавятся поля для создания новой линии (рис. 52). В поле **Линии (м)** следует указать длину линии, которую необходимо добавить, а в поле Азимуты (°) – угол поворота.

Новая линия отобразится на карте. Другие линии фигуры следует создать аналогичным способом.

 .. figure:: _static/scenarii_35_3.png
           :scale: 100 %
           :align: center        
           
           Рисунок 52 – Строка новой координаты

Если какую-либо из линий фигуры требуется выделить на карте, следует нажать на кнопку, на которой обозначены порядковые номера точек данной линии (рис. 53).

Если какие-либо линии фигуры следует поменять местами, следует использовать команды контекстного меню **Поднять наверх** и **Опустить вниз** (рис. 51).

Если требуется удалить какую-либо линию фигуры, следует выполнить для этой линии команду контекстного меню **Удалить**.

 .. figure:: _static/scenarii_35_4.png
           :scale: 100 %
           :align: center        
           
           Рисунок 53 – Просмотр линии на карте
...
Чтобы открыть таблицу, предназначенную для поиска сигналов, в меню быстрого доступа к функциональности следует нажать на кнопку **Сигналы** (рис. 54).

Таблица содержит следующие инструменты управления:

1. **Командные кнопки** (рис. 54, цифра 1) – отображаются при наличии соответствующих прав (права выдаются администратором системы) и
...
.. figure:: _static/poisk_signalov_1.png
           ...
           Рисунок 54 – Таблица для поиска сигналов

2. **Фильтры для отбора данных** (рис. 54, цифра 2) – по умолчанию в
...
В нижней части таблицы расположена информационная строка (рис. 54, цифра
...
команду контекстного меню **Новая вкладка > Поисковая форма** (рис. 55).

.. figure:: _static/poisk_signalov_2.png
           :scale: 100 %
           :align: center        
           
           Рисунок 55 – Переход к вкладке **Поиск**

Откроется вкладка **Поиск** (рис. 56).
...
Откроется новая вкладка (рис. 57), в которой отобразятся результаты
...
Чтобы открыть карту, в меню быстрого доступа к функциональности нажмите на кнопку **Карта** (рис. 58).

.. figure:: _static/karta_1.png
           :scale: 100 %
           :align: center        
           
           Рисунок 58 – Кнопка **Карта**

Карта откроется в новой вкладке (рис. 59).

.. figure:: _static/karta_2.png
           :scale: 100 %
           :align: center        
           
           Рисунок 59 – Инструменты работы с картой
...
Для работы с картой предназначены следующие инструменты управления (рис. 59):
...
подсказка (рис. 60), которая содержит основную информацию об инциденте
...
.. figure:: _static/karta_8.png
           ...
           Рисунок 60 – Всплывающее окно

При увеличении масштаба карты точки слоя, расположенные близко друг к
другу, объединяются в кластеры (рис. 61). На каждом кластере
...
.. figure:: _static/karta_10.png
           ...
           Рисунок 62 – Кнопка перехода в меню управления слоями

В меню управления слоями сгруппированы инструменты управления картой и
группы слоев/слои.

Меню управления слоями содержит следующие инструменты (рис. 63):
...
-  Группа полей для поиска требуемого территориального объекта: края,
   ...
   объекте (рис. 63). Границы объекта выделяются цветом. В центре
...
.. figure:: _static/karta_11.png
           ...
           Рисунок 63 – Инструменты для поиска по координатам и территориальному объекту

-  Кнопка **Сохранить настройки карты** (рис. 64) – при нажатии на
...
.. figure:: _static/karta_13.png
           ...
           Рисунок 64 – Меню управления слоями

Меню управления слоями содержит следующие группы слоев/слои:

1. **Данные мониторинга** (рис. 65) – в этой группе объединены слои, в
...
.. figure:: _static/karta_14.png
           ...
           Рисунок 65 – Группа слоев **Данные мониторинга**

2. **Блок ориентирования** (рис. 66) - в этом блоке объединены слои, которые являются дополнительным источником данных о состоянии лесного покрова на требуемых территориях.
   ...
   -  **Космические снимки высокого разрешения** (рис. 67) – в данной группе слоев содержатся композиты различных сервисов (Google, Ersi и других), которые созданы из серии снимков высокого и сверхвысокого разрешения.
...
.. figure:: _static/karta_15.png
           ...
           Рисунок 66 – Группа слоев **Блок ориентирования**

.. figure:: _static/karta_16.png
           :scale: 100 %
           :align: center        
           
           Рисунок 67 – Группа слоев **Блок ориентирования**

3. Блок принятия решений (рис. 68):
   ...
   -  **Леса ограниченного пользования** и **Ценные леса** (рис. 69) – территории, на которых запрещается осуществление деятельности, несовместимой с их целевым назначением и полезными функциями. Если точка сигнала о лесоизменении расположена на такой территории, то данный сигнал принимается в обработку в первую очередь.
...
.. figure:: _static/karta_17.png
           ...
           Рисунок 68 – Группа слоев **Блок принятия решений**

.. figure:: _static/karta_18.png
           :scale: 100 %
           :align: center        
           
           Рисунок 69 – Группа слоев **Блок принятия решений**
...
2. Откройте календарь нажатием на кнопку |image21| (рис. 71). Щелчком
...
карточку нарисованного объекта (рис. 74).
...
которые можно перемещать с помощью мыши (рис. 75). Установите точки в
...
.. figure:: _static/karta_30.png
           ...
           Рисунок 75 – Режим редактирования полигона
...
можно перемещать с помощью мыши (рис. 77). Установите точки в требуемое
...
.. figure:: _static/karta_33.png
           ...
           Рисунок 77 – Режим редактирования линии
...
Меню быстрого доступа к функциональности (рис. 78) содержит следующие кнопки:
...
.. figure:: _static/upravlenie_funkcionalom_1.png
           ...
           Рисунок 78 – Меню быстрого доступа к функциональности

Система «Кедр» на версиях платформы 2014 и 2017 года
====================================================

Система «Кедр» была разработана на версиях платформы «CITORUS» 2014 и 2017 года. Таблица сравнительных характеристик данных версий платформы представлена в руководстве «Платформа автоматизации CITORUS», в разделе `Версии платформы 2014 и 2017 года`_.

Интерфейс системы, разработанной на версии платформы 2014 года, представлен на рисунке 79. Интерфейс системы, разработанной на версии платформы 2017 года, представлен на рисунке 80.

.. figure:: _static/interfeis_1.png
           :scale: 100 %
           :align: center        
           
           Рисунок 79 – Система «Кедр» на версии платформы 2014 года

.. figure:: _static/interfeis_2.png
           :scale: 100 %
           :align: center        
           
           Рисунок 80 – Система «Кедр» на версии платформы 2017 года
...
+-----------+--------------+-------------------------------------------------------------------------------------------------+
| v.1.012   | 26.01.2018   | Внесены правки.                                                                                 |
+-----------+--------------+-------------------------------------------------------------------------------------------------+
| v.1.022   | 29.01.2018   | Добавлено описание поворотных углов.                                                            |
+-----------+--------------+-------------------------------------------------------------------------------------------------+
