...
1. Нажать правой клавишей мыши на кнопку |image32|, которая расположена слева от требуемой координаты. Например, если новую точку следует добавить между первой и второй координатой, необходимо нажать на кнопку |image32|, расположенную слева от первой координаты (рис. 48). Затем требуется выполнить одну из следующих команд контекстного меню:
